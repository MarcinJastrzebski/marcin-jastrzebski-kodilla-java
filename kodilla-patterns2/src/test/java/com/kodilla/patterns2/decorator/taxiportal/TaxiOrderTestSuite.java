...
public class TaxiOrderTestSuite {
    ...
    public void testMyTaxiWithChildSeatGetCost() {
        ...
        BigDecimal calculatedCost = theOrder.getCost();
        // Then
        Assertions.assertEquals(new BigDecimal(37), calculatedCost);
    }
    ...
    public void testUberWithTwoChildSeatsGetCost() {
        ...
        BigDecimal calculatedCost = theOrder.getCost();
        // Then
        Assertions.assertEquals(new BigDecimal(29), calculatedCost);
    }
    ...
    public void testVipTaxiWithChildSeatExpressGetCost() {
        ...
        BigDecimal calculatedCost = theOrder.getCost();
        // Then
        Assertions.assertEquals(new BigDecimal(52), calculatedCost);
    }
